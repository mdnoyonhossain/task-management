...
const Navbar = () => {
    ...
    const mainMenu = <>
        <Link to="/add-task" className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-white mr-4">
            Add Task
        </Link>
        <Link to="/my-task" className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-white mr-4">
            My Task
        </Link>
        <Link to="/completed-task" className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-white mr-4">
            Completed Task
        </Link>
    </>
    return (
